...
#    Updated: 2023/03/28 13:12:31 by teecharo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Source files.
SRC			= ft_memset.c ft_memcpy.c ft_memmove.c ft_memcmp.c ft_memchr.c\
			  ft_strrchr.c ft_strlen.c ft_strchr.c ft_isalpha.c ft_bzero.c\
			  ft_strncmp.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c\
			  ft_strlcpy.c ft_strnstr.c  ft_strlcat.c ft_toupper.c ft_tolower.c\
